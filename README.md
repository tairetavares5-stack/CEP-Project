...
|-------------------------|----------------------|---------------------|
|Taire Tavares            |tatavares@myseneca.ca |tairetavares5-stack  |
|Luka Lutidze             |llutidze@myseneca.ca  |lukalutidze-source   |
|Abdulhamid Alimi         |aoalimi1@myseneca.ca  |Hammy23              |
...
## Some key performance metrics includes ;
### Page load time 
This is the span being required by a webpage to be completely available for use to user  in their browser and the span required to fetch necessary resources from the server and render them on the device.
### Total page size 
